...
\def\thumblast{}  % Last thumb of preceeding page
\def\thumbstack{} % Stack holding thumbs pushed on current page
% At start of page, if there are no new thumbs then use the (last) old one
...
\newcommand{\drawthumb}[3]{%
  \begin{tikzpicture}[remember picture, overlay]
    \node [thumb, fill={thumbcolors!![#1]}, anchor=south #2]
...
%\def\drawrectothumblist#1,#2\relax{%
%  \if\relax#1\relax\else\drawrectothumb{#1}\fi%
%  \if\relax#2\relax\else\drawrectothumblist#2\relax\fi%
%  \gdef\thumblast{#1,}%
%  \gdef\thumbstack{}}
%
%\def\drawversothumblist#1,#2\relax{%
%  \if\relax#1\relax\else\drawversothumb{#1}\fi%
%  \if\relax#2\relax\else\drawversothumblist#2\relax\fi%
%  \gdef\thumblast{#1,}%
%  \gdef\thumbstack{}}
...
\fancypagestyle{myheadings}{
  ...
  \fancyhead[CE]{\thepage\expandafter\thumbgobblewith\thumbstack<\drawversothumb>}
