...
\NewDocumentCommand\dicIdiom{mo}
  {\dicSubEntry{\color{newdev}\dicStyleIntTerm{#1} %
     \IfValueTF{#2}{+ \dicStyleIntTerm{#2} \markboth{#1 + #2}{#1 + #2}}%
...
%\begin{document}
%%\foreach \lett in {\alphabet}{\expandafter\dicLetter{\lett}}
%\dictionarygeometry
%\pagestyle{myheadings}
%\dicLetter{R}\lipsum\lipsum\lipsum\lipsum\lipsum\lipsum
