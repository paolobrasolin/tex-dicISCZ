...
\newcommand\entryfigure[3]{
  \setlength\fboxsep{0pt}\setlength\fboxrule{0.5pt}
  \def\imagebox{\fbox{%
    \includegraphics [ max height = 0.8\columnwidth
                     , max width  = 0.8\columnwidth ] {#1}}}
  \newlength\imageheight
  \settototalheight\imageheight{\imagebox}
  \addtolength\imageheight{\fboxrule}
  \newcounter{imagelines}
  \setcounter{imagelines}{1+\imageheight/\baselineskip}
  \newlength\imageskip
  \setlength{\imageskip}{\baselineskip*\value{imagelines}-\imageheight+\fboxrule}
  \setlength\intextsep        {0pt}
  \setlength\textfloatsep     {0pt}
  \setlength\abovecaptionskip {0pt}
  \setlength\belowcaptionskip {0pt} 
  \begin{figure}[ht]
    \centering\vspace{\imageskip}\imagebox\caption{#2}
  \end{figure}
  \index{#3}
}

\newcommand{\makefigure}[2]{}
\newcommand{\makefigureh}[2]{}
...
\newcommand{\oddthumb}[1]{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node [thumb, fill=\BoxColor{#1}, text centered, anchor=north east]
...
\newcommand{\eventhumb}[1]{%
  % see pgfmanual.pdf for more information about this part
  \begin{tikzpicture}[remember picture, overlay]
    \node [thumb, fill=\BoxColor{#1}, text centered, anchor=north west]
...
\newcommand{\lettergroup}[1]{%
  ...
  \fancyhead[LO]{\phvfamily{\textbf{\rightmark}}%
    \expandafter\ethumbs\thumbnew\relax\relax\relax}%
  \fancyhead[RE]{\phvfamily{\textbf{\leftmark}}%
...
\newcommand\makecover[1]{
 ...
 \begin{center}
 \vspace*{0.3cm}%{\fill}
 {\fontsize{20}{20}\scshape\color{white}%
   \dictnameCZ\\\dictnameIS}
 %\vspace*{1em}                        % Maybe a spacer?
