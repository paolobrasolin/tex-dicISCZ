...
\NewDocumentCommand\dicLink{smd<>}
  {\IfBooleanF{#1}{\dicsymSee~}%
   \hyperref[term:#2\IfValueT{#3}{:#3}]{\dicStyleIntTerm{#2\dicMaybeSuper{#3}}}}
\NewDocumentCommand\dicSynonym{smd<>}
  {(\IfBooleanF{#1}{\dicsymSee~}\dicStyleExtTerm{#2\dicMaybeSuper{#3}})}
\NewDocumentCommand\dicAntonym{smd<>}
  {(\IfBooleanF{#1}{\dicsymCompare~}\dicStyleExtTerm{#2\dicMaybeSuper{#3}})}
